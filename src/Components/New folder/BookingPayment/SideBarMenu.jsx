...
const  SideBarMenu = ({selectedMethode,setSelectedMethode,subMenuSelected,setSubMenuSelected}) => {
 ...
 const handlesubmenu =(event)=>{
  ...
  return (
    <div className="payment_menu_main">
      ...
      {openCard && (
        <ul className="pay_submenu">
          <li
            className={`submenu_hbl_color ${
              subMenuSelected === 'hbl_banking' ? 'submenu_backgorund_selected' : ''
            }`}
            onClick={() => handlesubmenu('hbl_banking')}
          >
            <div className="d-flex justify-content-between">
              <div>
                <img src={images.hbllogo} alt="" width="32px" className="payment_logo_size" /> HBL
              </div>
              <div>
                {subMenuSelected === 'hbl_banking' && (
                  <KeyboardArrowRightIcon className="align-self-center submenu_arrow" />
                )}
              </div>
            </div>
          </li>
          <li
            className={`submenu_sepration ${
              subMenuSelected === 'jazzCash' ? 'submenu_backgorund_selected' : ''
            }`}
            onClick={() => handlesubmenu('jazzCash')}
          >
            <div className="d-flex justify-content-between">
              <div>
                <img src={images.jazzcash_Logo} alt="" width="32px" className="payment_logo_size" /> JazzCash
              </div>
              <div>
                {subMenuSelected === 'jazzCash' && (
                  <KeyboardArrowRightIcon className="align-self-center submenu_arrow" />
                )}
              </div>
            </div>
         ...
         <div className='payments_methode'>
             <div className='d-flex justify-content-between mob_line_spacing' onClick={handlePayMoreMethode}>
                <div  className='d-flex justify-content-start'>
                    ...
                    <h5 className='mob_methode_name align-self-center'>PayMore</h5>
                </div>
                   <KeyboardArrowRightIcon className='mob_forward_icon'/>
             </div>
             <div className='mob_doted_line'></div>
             <div className='d-flex justify-content-between mob_line_spacing' onClick={handleJazzCash}>
                  <div className='d-flex justify-content-start'>
                    <img src={images.jazzcash_Logo} alt="" width="32px" className="payment_logo_size" /> 
                    <h5 className='mob_methode_name align-self-center p-0'>JazzCash</h5>
                  </div>
                   <KeyboardArrowRightIcon className='mob_forward_icon'/>
             </div>
             <div className='mob_doted_line'></div>
